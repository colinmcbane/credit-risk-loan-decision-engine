...
def layout():
    ...
    return html.Div([
        ...
        # ── Charts row 1 ─────────────────────────────────────────────────
        dbc.Row([
            dbc.Col(dcc.Graph(figure=build_roc_chart(df), config={"displayModeBar": False, "staticPlot": True}), width=6),
            dbc.Col(dcc.Graph(figure=build_ks_gini_chart(df), config={"displayModeBar": False, "staticPlot": True}), width=6),
        ], className="mb-5"),

        # ── Confusion matrix ──────────────────────────────────────────────
        dbc.Row([
            dbc.Col(dcc.Graph(figure=build_confusion_matrix(df), config={"displayModeBar": False, "staticPlot": True}), width=6),
            dbc.Col([
